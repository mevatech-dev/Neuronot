...
Hafta 6: Profile/Settings backend overhaul (zorunlu AI consent + 9 endpoint) için end-to-end smoke test. Consents audit, AI consent gate, şifre değiştir, veri export ve hesap silme akışlarını kapsar.
...
- `user_agent` plaintext'tir (PII değil, telemetri); `HAFTA6-smoke/1.0` değeri görünür.
